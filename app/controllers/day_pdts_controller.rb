class DayPdtsController < ApplicationController
  ...
  def verify_index
    ...
    @factories.each do |factory|
      @day_pdts = factory.day_pdts.where(:state => [Setting.day_pdts.verifying, Setting.day_pdts.rejected, Setting.day_pdts.cmp_verifying, Setting.day_pdts.cmp_rejected]).order("pdt_date DESC")
